// Front Porch Economics - Cloudflare Worker
// Handles signup form submissions → D1 database
    ...
    if (request.method === 'POST' && url.pathname === '/signup') {
      try {
        ...
        await env.DB.prepare(
          ...
          .bind(email, name || null, neighborhood || null, building || null)
          .run();
